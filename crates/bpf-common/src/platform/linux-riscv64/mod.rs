...
pub fn syscalls() -> &'static HashMap<usize, &'static str> {
    ...
    SYSCALLS.get_or_init(|| {
        ...
        m.insert(259, "RISCV_FLUSH_ICACHE");
        m.insert(260, "WAIT4");
        ...
        m.insert(291, "STATX");
        m.insert(292, "IO_PGETEVENTS");
        m.insert(293, "RSEQ");
        m.insert(294, "KEXEC_FILE_LOAD");
        ...
        m.insert(435, "CLONE3");
        m.insert(436, "CLOSE_RANGE");
        m.insert(437, "OPENAT2");
        m.insert(438, "PIDFD_GETFD");
        m.insert(439, "FACCESSAT2");
        m.insert(440, "PROCESS_MADVISE");
        m.insert(441, "EPOLL_PWAIT2");
        m.insert(442, "MOUNT_SETATTR");
        m.insert(443, "QUOTACTL_FD");
        m.insert(444, "LANDLOCK_CREATE_RULESET");
        m.insert(445, "LANDLOCK_ADD_RULE");
        m.insert(446, "LANDLOCK_RESTRICT_SELF");
